...
/**
 * The condition that counts how many descendants verify a given condition.
...
internal class CountDescendants(private val condition: Condition,
  ...
  companion object {
     ...
     */
    const val ANNOTATION: String = "count-descendants"
  }

  /**
   * Build a [CountDescendants] condition from a JSON object.
   *
   * @param jsonObject the JSON object that represents a [CountDescendants] condition
   *
