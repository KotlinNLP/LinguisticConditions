...
/**
 * The 'all-descendants' operator.
 * It verifies that all the descendants of a given token verify the [condition].
 *
 * @param condition the condition to which this operator is applied
 */
internal class AllDescendants(condition: Condition) : Operator.Single(condition) {
