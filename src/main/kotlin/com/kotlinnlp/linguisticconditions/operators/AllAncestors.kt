...
/**
 * The 'all-ancestors' operator.
 * It verifies that all the ancestors of a given token verify the [condition].
 *
 * @param condition the condition to which this operator is applied
 */
internal class AllAncestors(condition: Condition) : Operator.Single(condition) {
  ...
  companion object {
     ...
     */
    const val ANNOTATION: String = "all-ancestors"
  }
